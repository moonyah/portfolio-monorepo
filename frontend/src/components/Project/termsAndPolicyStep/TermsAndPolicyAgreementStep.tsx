...
//               <input
//                 type="checkbox"
//                 className="relative w-4 h-4 mr-2 bg-transparent border border-gray-300 rounded-sm appearance-none checked:bg-blue-500 checked:border-transparent focus:outline-none"
//                 checked={agreed}
