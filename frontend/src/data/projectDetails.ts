...
export const projectDetails: Record<number, Project> = {
  1: {
    ...
    features: [
      ...
      //   name: 'Docker로 배포',
      //   description:
      //     'Docker를 활용한 로컬 개발 환경 설정과 배포 자동화 경험을 프로젝트에 반영하였습니다. Docker Compose를 이용해 프론트엔드, 백엔드, MongoDB를 컨테이너화하고 배포 효율성을 향상시켰습니다.',
      // },
      {
        name: 'npm 패키지 개발 및 적용',
        description:
          '직접 개발한 use-scroll-animation npm 패키지를 프로젝트에 적용하여 스크롤 애니메이션을 간편하게 구현하였습니다. 이 패키지는 사용자 경험을 향상시키는 부드러운 스크롤 효과를 제공하며, 코드 재사용성을 높이고 효율적인 코드 관리에 도움을 줍니다',
      },
      // {
      //   name: '방문자 수 및 방명록 기능',
      //   description:
      //     'MongoDB와 Axios를 사용하여 방명록 데이터를 실시간으로 처리하며, 사용자 피드백을 수집하였습니다. 방명록 외에도 방문자 수 추적 기능을 통해 실제 사용자 트래픽을 분석하고, 각 프로젝트에 대한 좋아요 기능을 추가하여 사용자 반응을 쉽게 확인할 수 있습니다.',
      // },
    ],
  },
  2: {
